        ...
        parent.fill(cont -> {
            ...
            if(true){
                ...
                wavesMain.table(select -> {
                    ...
                    select.defaults().size(dsize - 1f).left();
                    ...
                    select.button(port, style, isize, SchemeSize.input::toggleMobilePanCam).name("pancam").get().image().color(Pal.gray).width(4).height(dsize - 1f).padRight(dsize - 1f - isize);
